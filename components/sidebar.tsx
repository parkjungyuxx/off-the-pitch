    ...
    <>
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-20 flex-col items-center py-8 bg-sidebar z-20">
        <div className="mb-8">
          <Link href="/">
            <div className="w-12 h-12 flex items-center justify-center">
              <Image src="/logo.png" alt="OFF THE PITCH" width={48} height={48} className="rounded-full" />
            </div>
          </Link>
        </div>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="ghost" size="icon" className="w-12 h-12 rounded-xl hover:bg-sidebar-accent mt-auto">
              <CgDetailsMore className="w-6 h-6" />
              <span className="sr-only">More</span>
            </Button>
          </PopoverTrigger>
          <PopoverContent side="right" align="end" className="w-48 p-2 bg-[#141414] border-[#1a1a1a]">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-sidebar border-t border-sidebar-border flex items-center justify-around z-20">
        ...
        <Popover>
          ...
          <PopoverContent side="top" align="end" className="w-48 p-2 bg-[#141414] border-[#1a1a1a]">
            <div className="space-y-1">
              <Button
                variant="ghost"
                className="w-full justify-start gap-3 text-sm font-normal hover:bg-sidebar-accent"
